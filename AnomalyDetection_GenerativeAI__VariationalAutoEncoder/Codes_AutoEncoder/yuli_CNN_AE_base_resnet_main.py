"""
Objective: Train an AutoEncoder NN model from scratch. This could be used for anomaly detection or
...
from yuli_CNN_AE_base_resnet_train import train_with_early_stop
import yuli_CNN_AE_base_resnet_config as cfg
from yuli_CNN_AE_base_resnet_NNmodel import AutoEncoder
from yuli_CNN_AE_base_resnet_NNdataset import Dataset4Image
from yuli_CNN_AE_base_resnet_evaluation import EvalModel
from yuli_CNN_AE_base_resnet_data import get_pre_exist_model
device = cfg.device
